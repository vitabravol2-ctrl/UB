...
class MainWindow(QMainWindow):
    ...
    def open_settings_dialog(self) -> None:
        ...
        tab_map = [("Harvest", ["min_spread", "entry_offset", "exit_offset", "target_capture", "stop_loss", "max_hold_ms"]), ("Risk", ["lot_size", "max_open_lots", "max_daily_loss", "max_exposure_u", "panic_exit"]), ("Data", ["rest_poll_ms", "ws_optional_enabled", "max_ws_age_ms"]), ("Safety", ["live_enabled", "require_confirmation", "auto_cancel_on_stop"])]
    ...
    def cancel_all(self) -> None: self.log("WARNING", "cancel all requested")
