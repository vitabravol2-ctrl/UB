...
class SettingsData:
    ...
    buy_timeout_ms: int = 700
    buy_timeout_ms_fast: int = 250
    buy_watchdog_ms: int = 700
    ...
    stream_target_ticks: int = 28
    stream_min_profit_ticks: int = 10
